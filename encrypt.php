...
h1 {
  ...
  <div id="master-wrap">
    <div id="logo-box">
      ...
      <h2>Message encrypted successfully!</h2>
  		<hr/>
      <?php
      echo '<div class="wrap-all">';
      echo 'Key: <strong><font color="red">'.$inputKey.'</font></strong><br/>';
      echo 'Cipher text: <strong><font color="red">'.$enc.'</font></strong><br/>';
      echo "</div>";
       ?>
        <h1>Thank you</h1>
      </div>
      ...
      <div class="notice animated fadeInUp">
        <p class="lead">Your message has been successfully Encrypted!</p>
